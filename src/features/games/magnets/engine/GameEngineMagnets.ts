 ...
 */
class GameEngineMagnets {
  private static instance: GameEngineMagnets | null = null;
  ...
  private currentLevel: ILevel<'magnet'> | null = null;
  ...
  private selectedMagnet: Magnet | null = null;
   ...
   */
  public static getInstance(): GameEngineMagnets {
    if (!GameEngineMagnets.instance) {
      GameEngineMagnets.instance = new GameEngineMagnets();
    }
    return GameEngineMagnets.instance;
  }
  ...
  public initialize(
    ...
    const sketch = (p: p5) => {
      ...
      p.setup = () => {
        ...
        const levelMagnets: Magnet[] = levelData.magnets || [];
        ...
        this.magnets.push(...(levelData.magnets || []));
   ...
   */
  public updateMagnets(magnets: Magnet[]): void {
   ...
   */
  public applyMagneticForces(magnets: Magnet[]): void {
    if (
      !this.ball ||
      !this.engine ||
      !this.isWorldReady ||
  ...
  private applyEntityMovements() {
    const updateEntity = <T extends Wall | Magnet>(entity: T) => {
...
export default GameEngineMagnets;
