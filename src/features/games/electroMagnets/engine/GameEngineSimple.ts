 ...
 */
class GameEngineElectroSimple {
  private static instance: GameEngineElectroSimple | null = null;
   ...
   */
  public static getInstance(): GameEngineElectroSimple {
    if (!GameEngineElectroSimple.instance) {
      GameEngineElectroSimple.instance = new GameEngineElectroSimple();
    }
    return GameEngineElectroSimple.instance;
  }
  ...
  public initialize(
    ...
    const sketch = (p: p5) => {
      ...
      p.mouseReleased = () => {
        this.handleMagnetRelease(); // Handle magnet release on mouse release
      };
    };
  ...
  public update(): void {
    // console.log('');
    // console.log('#1 Engine: ', !this.engine);
    // console.log('#2 isWorldReady: ', !this.isWorldReady);
    // console.log('#3 gameStatus: ', this.gameStatus !== 'playing');
    // console.log('#4 ball: ', !this.ball);
    // console.log('#5 currentLevel: ', !this.currentLevel);
    // console.log('');
  ...
  private handleMagnetRelease() {
    if (this.selectedMagnet) {
      Matter.Body.setStatic(this.selectedMagnet.body, false); // Make static again
...
export default GameEngineElectroSimple;
